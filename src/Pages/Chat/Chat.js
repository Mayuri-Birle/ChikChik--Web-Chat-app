...
export default class Chat extends React.Component{
    constructor(props){
        ...
        this.state= {
            ...
            displayContentSwitchedNotification:[],
            displayedContacts: []
        }
...
this.setState({
    displayContentSwitchedNotification: this.currentUserMessages
})
this.getListUser()
    })
})
    ...
    getClassnameforUserandNotification = (itemId) =>{
        ...
        if(this.state.currentPeerUser && this.state.currentPeerUser.id === itemId){
            ...
            this.state.displayContentSwitchedNotification.forEach((item) => {
    ...
    notificationErase = (itemId)=>{
        this.state.displayContentSwitchedNotification.forEach((el) => {
    ...
    updaterenderList =() =>{
        ...
        this.setState({
            displayContentSwitchedNotification: this.notificationMessagesErase
        })
    }
    renderListUser = () =>{
                ...
                if(item.id != this.currentUserId){
                    ...
                    viewListUser.push(
                        ...
                        onClick = {()=>{
                            ...
                            document.getElementById(item.key).style.color = '#000'
                        }}
                    >
                        <img
